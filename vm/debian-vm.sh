...
qm set $VMID \
  ...
  -boot order=scsi0 \
  -serial0 socket \
  -description "<div align='center'><a href='https://Helper-Scripts.com'><img src='https://raw.githubusercontent.com/tenninjas/Proxmox/main/misc/images/logo-81x112.png'/></a>
...
echo "More Info at https://github.com/tenninjas/Proxmox/discussions/1988"
